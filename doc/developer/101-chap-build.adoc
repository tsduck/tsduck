...
TSDuck also provides native support for https://nixos.org[Nix], Linux and macOS.
...
[source,shell]
----
$ nix profile install github:tsduck/tsduck?dir=pkg/nix
----
...
[source,shell]
----
$ nix profile install github:tsduck/tsduck/v3.40?dir=pkg/nix            # a tagged release
$ nix profile install github:tsduck/tsduck/develop?dir=pkg/nix          # a branch
$ nix profile install github:tsduck/tsduck/v3.40?dir=pkg/nix#tsduck-min # tag + variant
----
...
[source,shell]
----
$ nix profile install github:tsduck/tsduck?dir=pkg/nix#tsduck-min
----
...
[source,shell]
----
$ nix profile install github:tsduck/tsduck?dir=pkg/nix#python-tsduck       # against tsduck
$ nix profile install github:tsduck/tsduck?dir=pkg/nix#python-tsduck-min   # against tsduck-min
----
...
[source,shell]
----
$ nix profile install github:tsduck/tsduck?dir=pkg/nix#java-tsduck       # against tsduck
$ nix profile install github:tsduck/tsduck?dir=pkg/nix#java-tsduck-min   # against tsduck-min
----
