...
Starting with version 3.43, TSDuck is part of the FreeBSD Ports.
...
NOTE: TSDuck is supposed to be included the April 2026 "Quarterly" branch of the FreeBSD Ports.
