...
TSDuck also provides native support for https://nixos.org[Nix],
a declarative package manager that works across Linux, macOS, and BSD systems,
offering reproducible builds and automatic dependency management.
...
TSDuck provides native https://nixos.org[Nix] flake support for reproducible builds across Linux, macOS, and BSD systems.
Nix provides hermetic, reproducible builds with automatic dependency management.
...
[source,shell]
----
$ nix build github:tsduck/tsduck
$ nix run github:tsduck/tsduck
$ nix develop github:tsduck/tsduck
----
...
The flake provides several package variants:

[.compact-table]
[cols="<1m,<1",frame=none,grid=none,stripes=none,options="autowidth,noheader"]
|===
|tsduck |Full build (default)
|python-tsduck |Python bindings for TSDuck
|java-tsduck |Java bindings with JDK runtime dependency
|===

===== Building TSDuck with Nix

To build the full TSDuck package:
...
----
$ nix build .#tsduck
$ nix build .#python-tsduck
$ nix build .#java-tsduck
----
...
[source,shell]
----
$ nix develop           # Main development shell with all tools
$ nix develop .#python  # Python environment with TSDuck bindings
----
...
===== Running TSDuck commands

Run TSDuck commands directly without installation:

[source,shell]
----
$ nix run .#default -- --version
$ nix run .#tsp -- --help
$ nix run .#tsanalyze -- input.ts
----
...
[source,shell]
----
$ nix profile install github:tsduck/tsduck
----
...
----
$ nix run github:tsduck/tsduck
$ nix run github:tsduck/tsduck#tsp -- --help
----
...
[source,shell]
----
$ nix profile install github:tsduck/tsduck#python-tsduck
----

Install Java bindings with JDK:

[source,shell]
----
$ nix profile install github:tsduck/tsduck#java-tsduck
----
