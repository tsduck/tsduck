...
To develop some custom form of transport stream input, C++ developers should rather develop their own input plugin.
...
[.compact-list]
* In C++, the event data is an instance of `PluginEventData` pointing to the input buffer.
