...
[.optdoc]
Select packets with a DTS (in a clear PES header).

[.opt]
*--dts-range* _minvalue[-maxvalue]_

[.optdoc]
Select packets with a DTS value in the specified range.
...
[.opt]
*--pcr-range* _minvalue[-maxvalue]_

[.optdoc]
Select packets with a PCR or OPCR value in the specified range.

[.opt]
*--pes*

[.optdoc]
Select packets with a clear PES header.
...
[.optdoc]
Select packets with a PTS (in a clear PES header).

[.opt]
*--pts-range* _minvalue[-maxvalue]_

[.optdoc]
Select packets with a PTS value in the specified range.
