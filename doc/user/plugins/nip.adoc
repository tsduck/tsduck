...
NOTE: To analyze a DVB-NIP stream which is transported using GSE or natively on an IP network,
use the command `tsnip`. See xref:_tsnip[xrefstyle=short] for more details.
