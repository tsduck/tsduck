...
[.optdoc]
.Values for option `--delivery-system` (`dvb` plugin)
...
|DVB-T
|DVB-T
|`--bandwidth --frequency --guard-interval --hierarchy --high-priority-fec
...
|ISDB-T
|ISDB-T
|`--bandwidth --frequency --guard-interval --isdbt-layer-a-fec --isdbt-layer-a-modulation
...
Must be one of `none`, `auto`, `1/2`, `1/3`, `1/4`, `2/3`, `2/5`, `3/4`, `3/5`, `4/5`, `5/6`, `5/11`, `6/7`, `7/8`, `8/9`, `9/10`.
The default is `auto`.
...
Must be one of `1/2`, `2/3`, `3/4`, `5/6`, `7/8`, `auto`.
The default is `auto`.
...
Must be one of `QPSK`, `DQPSK`, `16-QAM`, `64-QAM`, `QAM` (auto).
...
[.optdoc]
Modulation type (aka constellation for DVB-T).

[.optdoc]
Must be one of `QPSK`, `8-PSK`, `16-APSK`, `32-APSK`, `QAM` (auto-detected QAM),
...
[.optdoc]
Specifiy the Physical Layer Scrambling (PLS) code value, from 0 to 262143 (0x3FFFF).
...
[.optdoc]
Roll-off factor.
Must be one of `auto`, `0.35`, `0.25`, `0.20`.
