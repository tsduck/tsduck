...
|ALC |Asynchronous Layered Coding (DVB-NIP)
...
|FDT |File Delivery Table (DVB-NIP)
|FEC |Forward Error Correction
|FIPS |Federal Information Processing Standard
|FLUTE |File Delivery over Unidirectional Transport (DVB-NIP)
|FTA |Free To Air
...
|LCT |Layered Coding Transport (DVB-NIP)
...
|NIF |Network Information File (DVB-NIP)
...
|ROUTE |Real-Time Transport Object Delivery over Unidirectional Transport (ATSC 3.0, DVB-NIP)
...
|SIF |Service Information File (DVB-NIP)
|SIT |Selection Information Table (DVB)
|SLEP |Service List Entry Point (DVB-I, DVB-NIP)
...
|TOI |Transport Object Identifier (DVB-NIP)
...
|TSI |Transport Session Identifier (DVB-NIP)
...
* [[[ABNT-NBR-15603-1]]] ABNT NBR 15603-1, Third edition, February 2023:
  "Digital terrestrial television – Multiplexing and service information (SI) - Part 1: SI for digital broadcasting systems".
* [[[ABNT-NBR-15603-2]]] ABNT NBR 15603-2, Sixth edition, February 2023:
  "Digital terrestrial television — Multiplexing and service information (SI) -
  Part 2: Data structure and definitions of basic information of SI".
* [[[ABNT-NBR-15603-3]]] ABNT NBR 15603-3, First edition, Corr. V3, June 2020:
  "Digital terrestrial television — Multiplexing and service information (SI) —
  Part 3: Syntaxes and definitions of extension information of SI".
* [[[ABNT-NBR-15608-3]]] ABNT NBR 15608-3, Sixth edition, February 2023:
  "Digital terrestrial television — Operational guideline -
  Part 3: Multiplexing and service information (SI) — Guideline for implementation of ABNT NBR 15603".
* [[[AOM-AV1]]] Alliance for Open Media (AOM):
  "Carriage of AV1 in MPEG-2 TS", October 2021, https://aomediacodec.github.io/av1-mpeg2-ts/
* [[[ARIB-B10]]] ARIB STD-B10, V5.13, December 2019:
...
* [[[ARIB-TRB14]]] ARIB TR-B14, V6.7, September 2020:
...
* [[[AstroMeta]]] AstroMeta (formerly VATek) corporate home page: https://www.astrometa.com.tw/
...
* [[[ETSI-103-876]]] ETSI TS 103 876, V1.1.1, September 2024:
  "Digital Video Broadcasting (DVB); Native IP Broadcasting" (DVB-NIP).
...
* [[[ITU-J1041]]] ITU-T Recommendation J.1041, March 2025:
  "Digital rights management for video and audio content distribution – System architecture"
...
* [[[Suntech]]] Suntechtv U3 USB modulator (AstroMeta-based),
...
* [[[VATek]]] See <<AstroMeta>>.
* [[[VATek-SDK]]] AstroMeta SDK source code: https://github.com/VisionAdvanceTechnologyInc/vatek_sdk_2
