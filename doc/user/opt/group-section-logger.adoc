...
each file is created with the name `base_pXXXX_tXX.ext` for short sections and
`base_pXXXX_tXX_eXXXX_vXX_sXX.ext` for long sections, where the `XX` respectively specify
