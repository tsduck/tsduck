...
and C++ classes for applications which are built on top of the TSDuck library.
...
The C++, Java or Python class named `TSProcessor` is the equivalent of `tsp` inside an application.
