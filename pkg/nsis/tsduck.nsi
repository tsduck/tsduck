...
Section "Tools & Plugins" SectionTools
    ...
    Delete "$INSTDIR\bin\tsplugin_aes.dll"
    Delete "$INSTDIR\bin\tsplugin_analyze.dll"
    Delete "$INSTDIR\bin\tsplugin_bat.dll"
    Delete "$INSTDIR\bin\tsplugin_bitrate_monitor.dll"
    Delete "$INSTDIR\bin\tsplugin_boostpid.dll"
    Delete "$INSTDIR\bin\tsplugin_cat.dll"
    Delete "$INSTDIR\bin\tsplugin_clear.dll"
    Delete "$INSTDIR\bin\tsplugin_continuity.dll"
    Delete "$INSTDIR\bin\tsplugin_count.dll"
    Delete "$INSTDIR\bin\tsplugin_craft.dll"
    Delete "$INSTDIR\bin\tsplugin_cutoff.dll"
    Delete "$INSTDIR\bin\tsplugin_datainject.dll"
    Delete "$INSTDIR\bin\tsplugin_decap.dll"
    Delete "$INSTDIR\bin\tsplugin_descrambler.dll"
    Delete "$INSTDIR\bin\tsplugin_drop.dll"
    Delete "$INSTDIR\bin\tsplugin_dsmcc.dll"
    Delete "$INSTDIR\bin\tsplugin_dump.dll"
    Delete "$INSTDIR\bin\tsplugin_duplicate.dll"
    Delete "$INSTDIR\bin\tsplugin_dvb.dll"
    Delete "$INSTDIR\bin\tsplugin_eit.dll"
    Delete "$INSTDIR\bin\tsplugin_eitinject.dll"
    Delete "$INSTDIR\bin\tsplugin_encap.dll"
    Delete "$INSTDIR\bin\tsplugin_feed.dll"
    Delete "$INSTDIR\bin\tsplugin_file.dll"
    Delete "$INSTDIR\bin\tsplugin_filter.dll"
    Delete "$INSTDIR\bin\tsplugin_flute.dll"
    Delete "$INSTDIR\bin\tsplugin_fork.dll"
    Delete "$INSTDIR\bin\tsplugin_fuzz.dll"
    Delete "$INSTDIR\bin\tsplugin_hides.dll"
    Delete "$INSTDIR\bin\tsplugin_history.dll"
    Delete "$INSTDIR\bin\tsplugin_hls.dll"
    Delete "$INSTDIR\bin\tsplugin_http.dll"
    Delete "$INSTDIR\bin\tsplugin_iat.dll"
    Delete "$INSTDIR\bin\tsplugin_identify.dll"
    Delete "$INSTDIR\bin\tsplugin_influx.dll"
    Delete "$INSTDIR\bin\tsplugin_inject.dll"
    Delete "$INSTDIR\bin\tsplugin_ip.dll"
    Delete "$INSTDIR\bin\tsplugin_isdbinfo.dll"
    Delete "$INSTDIR\bin\tsplugin_limit.dll"
    Delete "$INSTDIR\bin\tsplugin_merge.dll"
    Delete "$INSTDIR\bin\tsplugin_mpe.dll"
    Delete "$INSTDIR\bin\tsplugin_mpeextract.dll"
    Delete "$INSTDIR\bin\tsplugin_mpeinject.dll"
    Delete "$INSTDIR\bin\tsplugin_mux.dll"
    Delete "$INSTDIR\bin\tsplugin_nip.dll"
    Delete "$INSTDIR\bin\tsplugin_nipextract.dll"
    Delete "$INSTDIR\bin\tsplugin_nit.dll"
    Delete "$INSTDIR\bin\tsplugin_nitscan.dll"
    Delete "$INSTDIR\bin\tsplugin_null.dll"
    Delete "$INSTDIR\bin\tsplugin_pat.dll"
    Delete "$INSTDIR\bin\tsplugin_pattern.dll"
    Delete "$INSTDIR\bin\tsplugin_pcap.dll"
    Delete "$INSTDIR\bin\tsplugin_pcradjust.dll"
    Delete "$INSTDIR\bin\tsplugin_pcrbitrate.dll"
    Delete "$INSTDIR\bin\tsplugin_pcrcopy.dll"
    Delete "$INSTDIR\bin\tsplugin_pcrduplicate.dll"
    Delete "$INSTDIR\bin\tsplugin_pcredit.dll"
    Delete "$INSTDIR\bin\tsplugin_pcrextract.dll"
    Delete "$INSTDIR\bin\tsplugin_pcrverify.dll"
    Delete "$INSTDIR\bin\tsplugin_pes.dll"
    Delete "$INSTDIR\bin\tsplugin_pidshift.dll"
    Delete "$INSTDIR\bin\tsplugin_play.dll"
    Delete "$INSTDIR\bin\tsplugin_pmt.dll"
    Delete "$INSTDIR\bin\tsplugin_psi.dll"
    Delete "$INSTDIR\bin\tsplugin_psimerge.dll"
    Delete "$INSTDIR\bin\tsplugin_reduce.dll"
    Delete "$INSTDIR\bin\tsplugin_regulate.dll"
    Delete "$INSTDIR\bin\tsplugin_remap.dll"
    Delete "$INSTDIR\bin\tsplugin_rist.dll"
    Delete "$INSTDIR\bin\tsplugin_rmorphan.dll"
    Delete "$INSTDIR\bin\tsplugin_rmsplice.dll"
    Delete "$INSTDIR\bin\tsplugin_scrambler.dll"
    Delete "$INSTDIR\bin\tsplugin_sdt.dll"
    Delete "$INSTDIR\bin\tsplugin_sections.dll"
    Delete "$INSTDIR\bin\tsplugin_sifilter.dll"
    Delete "$INSTDIR\bin\tsplugin_skip.dll"
    Delete "$INSTDIR\bin\tsplugin_slice.dll"
    Delete "$INSTDIR\bin\tsplugin_spliceinject.dll"
    Delete "$INSTDIR\bin\tsplugin_splicemonitor.dll"
    Delete "$INSTDIR\bin\tsplugin_splicerestamp.dll"
    Delete "$INSTDIR\bin\tsplugin_srt.dll"
    Delete "$INSTDIR\bin\tsplugin_stats.dll"
    Delete "$INSTDIR\bin\tsplugin_stuffanalyze.dll"
    Delete "$INSTDIR\bin\tsplugin_svremove.dll"
    Delete "$INSTDIR\bin\tsplugin_svrename.dll"
    Delete "$INSTDIR\bin\tsplugin_svresync.dll"
    Delete "$INSTDIR\bin\tsplugin_t2mi.dll"
    Delete "$INSTDIR\bin\tsplugin_tables.dll"
    Delete "$INSTDIR\bin\tsplugin_teletext.dll"
    Delete "$INSTDIR\bin\tsplugin_time.dll"
    Delete "$INSTDIR\bin\tsplugin_timeref.dll"
    Delete "$INSTDIR\bin\tsplugin_timeshift.dll"
    Delete "$INSTDIR\bin\tsplugin_timewrap.dll"
    Delete "$INSTDIR\bin\tsplugin_trace.dll"
    Delete "$INSTDIR\bin\tsplugin_trigger.dll"
    Delete "$INSTDIR\bin\tsplugin_tsrename.dll"
    Delete "$INSTDIR\bin\tsplugin_until.dll"
    Delete "$INSTDIR\bin\tsplugin_zap.dll"
