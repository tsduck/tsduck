...
namespace ts {
    ...
    //!
    TSCOREDLL bool SysCtrlBool(const std::string& name);
    //!
    ...
    //!
    TSCOREDLL UString SysCtrlString(std::initializer_list<int> oid);
    //!
    ...
    //!
    TSCOREDLL ByteBlock SysCtrlBytes(std::initializer_list<int> oid);
}
