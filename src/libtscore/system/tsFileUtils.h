...
#error "Unimplemented operating system"
    ...
    //!
    TSCOREDLL UString VernacularFilePath(const UString& path);
    ...
    //!
    TSCOREDLL bool IsAbsoluteFilePath(const UString& path);
    ...
    //!
    TSCOREDLL UString AbsoluteFilePath(const UString& path, const UString& base = UString());
    ...
    //!
    TSCOREDLL UString CleanupFilePath(const UString& path);
    ...
    //!
    TSCOREDLL UString DirectoryName(const UString& path);
    ...
    //!
    TSCOREDLL UString BaseName(const UString& path, const UString& suffix = UString());
    ...
    //!
    TSCOREDLL fs::path UserHomeDirectory();
    ...
    //!
    TSCOREDLL fs::path TempFile(const UString& suffix = u".tmp");
    ...
    //!
    TSCOREDLL Time GetFileModificationTimeLocal(const UString& path);
