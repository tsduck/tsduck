...
namespace ts {
    ...
    //!
    TSCOREDLL uint32_t UCharacteristics(UChar c);
    ...
    //!
    TSCOREDLL int ToDigit(UChar c, int base = 10, int defaultValue = -1);
    ...
    //!
    TSCOREDLL bool IsLower(UChar c);
    ...
    //!
    TSCOREDLL bool IsUpper(UChar c);
    ...
    //!
    TSCOREDLL UChar ToLower(UChar c);
    ...
    //!
    TSCOREDLL UChar ToUpper(UChar c);
    ...
    //!
    TSCOREDLL bool IsAccented(UChar c);
    ...
    //!
    TSCOREDLL UString RemoveAccent(UChar c);
    ...
    //!
    TSCOREDLL UString ToHTML(UChar c);
    ...
    //!
    TSCOREDLL UChar FromHTML(const UString& entity);
    ...
    //!
    TSCOREDLL UChar Precombined(UChar letter, UChar mark);
    ...
    //!
    TSCOREDLL bool DecomposePrecombined(UChar c, UChar& letter, UChar& mark);
