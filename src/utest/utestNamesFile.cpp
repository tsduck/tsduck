...
class NamesFileTest: public tsunit::Test
{
...
TSUNIT_DEFINE_TEST(PlatformId)
{
    ...
    TSUNIT_EQUAL(u"0x000004 (TV digitale mobile, Telecom Italia)", ts::NameFromDTV(u"INT.platform_id", 4, ts::NamesFlags::VALUE_NAME));
    TSUNIT_EQUAL(u"VTC Mobile TV (0x704001)", ts::NameFromDTV(u"INT.platform_id", 0x704001, ts::NamesFlags::NAME_VALUE));
}
