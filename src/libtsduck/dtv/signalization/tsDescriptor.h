...
namespace ts {
    ...
    public:
        ...
        //! Deserialize the descriptor.
        //! @param [in,out] duck TSDuck execution context.
        //! @param [in] context Context of the descriptor. Used to understand its identity.
        //! @return A safe pointer to an instance of a concrete subclass of AbstractDescriptor
        //! representing this descriptor. Return the null pointer if the descriptor could not
        //! be deserialized.
        //!
        AbstractDescriptorPtr deserialize(DuckContext& duck, const DescriptorContext& context = DescriptorContext()) const;
        ...
        //!
        xml::Element* toXML(DuckContext& duck, xml::Element* parent, const DescriptorContext& context = DescriptorContext(), bool force_generic = false) const;
