...
void ts::tr101290::Analyzer::logError(const UString& reference, ErrorCounter error, PID context)
{
    logError(reference, error, UString::Format(u"PID %n", context));
}

void ts::tr101290::Analyzer::logError(const UString& reference, ErrorCounter error, const UString& context)
{
    _duck.report().debug(u"raise %s (%s) in %s", GetCounterDescription(error).name, reference, context);
    if (_error_handler != nullptr) {
        _error_handler->handleTR101290Error(*this, error, reference, context);
    }
}

void ts::tr101290::Analyzer::setError(const UString& reference, ErrorCounter error, PID context)
{
    setError(reference, error, UString::Format(u"PID %n", context));
}

void ts::tr101290::Analyzer::setError(const UString& reference, ErrorCounter error, const UString& context)
{
    assert(int(error) >= 0);
    assert(error < COUNTER_COUNT);

    _counters_flags[error] = true;
    logError(reference, error, context);
}

void ts::tr101290::Analyzer::addError(const UString& reference, ErrorCounter error, PID context, Counters& counters)
{
    addError(reference, error, UString::Format(u"PID %n", context), counters);
}

void ts::tr101290::Analyzer::addError(const UString& reference, ErrorCounter error, const UString& context, Counters& counters)
{
    assert(int(error) >= 0);
    assert(error < COUNTER_COUNT);
...
void ts::tr101290::Analyzer::feedPacket(const PCR& timestamp, const TSPacket& pkt)
{
    ...
    if (pkt.hasValidSync()) {
        ...
        setError(u"1.2", Sync_byte_error, pid);
    ...
    if (!_continuity.feedPacket(pkt)) {
        setError(u"1.4", Continuity_count_error, pid);
    }
    ...
    if (pkt.hasPCR()) {
        ...
        if (!exp_disc && pidctx.last_pcr_value != INVALID_PCR && PCR(DiffPCR(pidctx.last_pcr_value, pcr)) > _max_pcr_difference) {
            ...
            setError(u"2.3/1", PCR_error, pid);
            ...
            setError(u"2.3.b", PCR_discontinuity_indicator_error, pid);
        }
    ...
    if (pkt.isScrambled()) {
        ...
        if (pidctx.is_pmt) {
            ...
            setError(u"1.5.a/2", PMT_error_2, pid);
        }
    }
    ...
    if (pidctx.last_timestamp >= PCR::zero()) {
        if (pid == PID_PAT && (_current_timestamp - pidctx.last_timestamp) > _max_pat_interval) {
            ...
            setError(u"1.3/1", PAT_error, pid);
        }
    ...
    switch (table.tableId()) {
        case TID_PAT: {
            if (pid == PID_PAT) {
                ...
                if (pat.isValid()) {
                    ...
                    setError(u"1.3.a/5U", PAT_error_2, pid);
                }
            }
            break;
        }
        case TID_CAT: {
            if (pid == PID_CAT) {
                ...
                if (cat.isValid()) {
                    ...
                    setError(u"2.6/4U", CAT_error, pid);
                }
            }
            break;
        }
        case TID_PMT: {
            ...
            if (pmt.isValid()) {
                ...
                setError(u"1.5.a/3U", PMT_error_2, pid);
            }
            break;
        }
        default: {
...
void ts::tr101290::Analyzer::handleSection(SectionDemux& demux, const Section& section)
{
    ...
    if (pid == PID_PAT && tid != TID_PAT) {
        ...
        setError(u"3.7/1", RST_error, pid);
    }
        ...
        setError(u"3.8/2", TDT_error, pid);
    }
    ...
    if (tid == TID_PAT) {
        ...
        if (pid != PID_PAT) {
            ...
            setError(u"1.3.a/4U", PAT_error_2, pid);
        }
            ...
            setError(u"1.3.a/1", PAT_error_2, u"PAT");
        }
        if (pid == PID_PAT) {
        ...
        if (ctx.invMax(_current_timestamp, _max_pmt_interval)) {
            ...
            setError(u"1.5/1", PMT_error, pid);
        ...
        if (pid != PID_RST) {
            ...
            setError(u"3.7/2", RST_error, pid);
        }
        if (pid == PID_RST) {
            ctx.last_timestamp = _current_timestamp;
        }
        ...
        if (pid != PID_TDT) {
            ...
            setError(u"3.8/4U", TDT_error, pid);
        }
            ...
            setError(u"3.8/3", TDT_error, pid);
        }
            ...
            setError(u"[3.8/1", TDT_error, pid);
        }
        if (pid == PID_TDT) {
            ctx.last_timestamp = _current_timestamp;
        }
        ...
        if (pid != PID_TOT) {
            ...
            setError(u"3.2/2U", SI_PID_error, pid);
        }
            ...
            setError(u"2.2/1", CRC_error, u"TOT");
        }
            ...
            setError(u"3.2/1", SI_repetition_error, u"TOT");
        }
        if (pid == PID_TOT) {
            ctx.last_timestamp = _current_timestamp;
        }
        ...
        if (pid != PID_NIT) {
            ...
            setError(u"3.1.a/4U", NIT_actual_error, pid);
        }
            ...
            setError(u"3.1.a/3", NIT_actual_error, pid);
        }
            ...
            setError(u"3.1.a/2", NIT_actual_error, pid);
        }
        if (pid == PID_NIT) {
            ctx.last_timestamp = _current_timestamp;
        }
        ...
        if (pid != PID_NIT) {
            ...
            setError(u"3.1.b/2U", NIT_other_error, pid);
        }
            ...
            setError(u"3.1.b/1", NIT_other_error, pid);
        }
        if (pid == PID_NIT) {
            ctx.last_timestamp = _current_timestamp;
        }
        ...
        if (pid != PID_SDT) {
            ...
            setError(u"3.5.a/4U", SDT_actual_error, pid);
        }
            ...
            setError(u"3.5.a/3", SDT_actual_error, pid);
        }
        ...
        if (pid != PID_SDT) {
            ...
            setError(u"3.5.b/2U", SDT_other_error, pid);
        }
            ...
            setError(u"3.5.b/1", SDT_other_error, pid);
        }
        if (pid == PID_SDT) {
            ctx.last_timestamp = _current_timestamp;
        }
        ...
        if (pid != PID_BAT) {
            ...
            // [[3.2/1]] SI_repetition_error: Repetition rate of SI tables outside of specified limits.
            setError(u"3.2/1", SI_repetition_error, u"BAT");
        }
        if (pid == PID_BAT) {
            ctx.last_timestamp = _current_timestamp;
        }
    ...
    if ((tid == TID_NIT_ACT || tid == TID_NIT_OTH) && pid == PID_NIT) {
        if (_last_nit_timestamp >= PCR::zero() && (_current_timestamp - _last_nit_timestamp) > _max_nit_interval) {
            ...
            setError(u"3.1/2", NIT_error, pid);
        }
    ...
    if (tid == TID_EIT_PF_ACT && pid == PID_EIT) {
        ...
        if (ctx.invMin(_current_timestamp, _min_eitpf_actual_interval)) {
            ...
            setError(u"3.6.a/4", EIT_actual_error, pid);
        }
    ...
    if (EIT::IsPresentFollowing(tid) && pid == PID_EIT) {
        ...
        if (secnum > 1) {
            ...
            setError(u"3.6.c/2U", EIT_PF_error, pid);
        }
        else {
            ...
            if (last_other >= PCR::zero() && (_current_timestamp - last_other) > _max_eitpf_actual_interval) {
                setError(u"3.6.c/1", EIT_PF_error, pid);
            }
            if (tid == TID_EIT_PF_ACT && ctx.last_time_01[secnum] >= PCR::zero() && (_current_timestamp - ctx.last_time_01[secnum]) > _max_eitpf_actual_interval) {
                ...
                setError(secnum == 0 ? u"3.6.a/1]]" : u"3.6.a/2", EIT_actual_error, pid);
            }
            if (tid == TID_EIT_PF_OTH && ctx.last_time_01[secnum] >= PCR::zero() && (_current_timestamp - ctx.last_time_01[secnum]) > _max_eitpf_other_interval) {
                ...
                setError(secnum == 0 ? u"3.6.b/1]]" : u"3.6.b/2", EIT_other_error, pid);
            }
...
void ts::tr101290::Analyzer::handleInvalidSection(SectionDemux& demux, const DemuxedData& data, Section::Status status)
{
    if (status == Section::INV_CRC32) {
        ...
        const UString context(UString::Format(u"%s in PID %n", TIDName(_duck, tid), data.sourcePID()));
    ...
    if (_last_timestamp >= PCR::zero()) {
        ...
        for (const auto& it : _pids) {
                ...
                (_last_timestamp - it.second.first_timestamp) > _max_pid_reference_interval)
            {
                ...
                addError(u"3.4", Unreferenced_PID, it.first, counters);
                ...
                logError(u"3.4.a", Unreferenced_PID, it.first);
            }
        }
        ...
        if (_pids[PID_PAT].last_timestamp >= PCR::zero() && (_last_timestamp - _pids[PID_PAT].last_timestamp) > _max_pat_interval) {
            // [[1.3/1]] PAT_error: PID 0x0000 does not occur at least every 0,5 s
            addError(u"1.3/1", PAT_error, PID_PAT, counters);
        }
        ...
        for (const auto& it : _pids) {
            if (it.second.user_pid && it.second.last_timestamp >= PCR::zero() && (_last_timestamp - it.second.last_timestamp) > _max_pid_interval) {
                // [[1.6]] PID_error: Referred PID does not occur for a user specified period.
                addError(u"1.6", PID_error, it.first, counters);
            }
        }
        ...
        for (const auto& it : _xtids) {
            ...
            if (tid == TID_PAT && it.second.invMax(_last_timestamp, _max_pat_interval)) {
                ...
                if (it.second.last_time_01[0] >= PCR::zero() && (_last_timestamp - it.second.last_time_01[0]) > _max_eitpf_other_interval) {
                    // [[3.6.b/1]] EIT_other_error: Interval between sections '0' with table_id = 0x4F (EIT-P, other TS) on PID 0x0012 longer than a specified value (10 s or higher).
                    addError(u"3.6.b/1]]", EIT_other_error, it.first.toString(), counters);
                }
                if (it.second.last_time_01[1] >= PCR::zero() && (_last_timestamp - it.second.last_time_01[1]) > _max_eitpf_other_interval) {
                    // [[3.6.b/2]] EIT_other_error: Interval between sections '1' with table_id = 0x4F (EIT-F, other TS) on PID 0x0012 longer than a specified value (10 s or higher).
                    addError(u"3.6.b/2", EIT_other_error, it.first.toString(), counters);
                }
            }
        }
        ...
        if (_last_nit_timestamp >= PCR::zero() && (_last_timestamp - _last_nit_timestamp) > _max_nit_interval) {
            // [[3.1/2]] NIT_error: No section with table_id 0x40 or 0x41 (i.e. an NIT) in PID value 0x0010 for more than 10 s.
            addError(u"3.1/2", NIT_error, u"NIT", counters);
        }
    }
}
