...
void ts::ISDBTInformationPacket::ModeGI::display(DuckContext& duck, std::ostream& strm, const UString& margin) const
{
    strm << margin << "initialization_timing_indicator: " << int(initialization_timing_indicator) << std::endl
         << margin << "current mode: " << NameFromDTV(u"ISDB.mode", current_mode, NamesFlags::FIRST)
         << ", guard interval: " << NameFromDTV(u"ISDB.guard_interval", current_guard_interval, NamesFlags::FIRST) << std::endl
         << margin << "next mode: " << NameFromDTV(u"ISDB.mode", next_mode, NamesFlags::FIRST)
         << ", guard interval: " << NameFromDTV(u"ISDB.guard_interval", next_guard_interval, NamesFlags::FIRST) << std::endl;
}
...
{
    strm << margin << "Modulation: " << NameFromDTV(u"ISDB.modulation", modulation_scheme, NamesFlags::FIRST)
         << ", coding rate: " << NameFromDTV(u"ISDB.coding_rate", coding_rate_of_inner_code, NamesFlags::FIRST) << std::endl
...
{
    strm << margin << "System identifier: " << NameFromDTV(u"ISDB.system_identification", system_identifier, NamesFlags::FIRST) << std::endl
