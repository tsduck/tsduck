...
#define MY_EDID     ts::EDID::Regular(ts::DID_MPEG_MVC_EXT, ts::Standards::MPEG)
...
void ts::MVCExtensionDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
