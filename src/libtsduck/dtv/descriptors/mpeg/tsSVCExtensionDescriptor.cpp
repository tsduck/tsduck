...
#define MY_EDID     ts::EDID::Regular(ts::DID_MPEG_SVC_EXT, ts::Standards::MPEG)
...
void ts::SVCExtensionDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
