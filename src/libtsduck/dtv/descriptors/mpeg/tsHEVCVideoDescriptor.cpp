...
#define MY_EDID     ts::EDID::Regular(ts::DID_MPEG_HEVC_VIDEO, ts::Standards::MPEG)
...
void ts::HEVCVideoDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
