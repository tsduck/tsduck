...
#define MY_DID ts::DID_MPEG_MPEG4_AUDIO_EXT
...
void ts::MPEG4AudioExtensionDescriptor::DisplayDescriptor(TablesDisplay& disp, PSIBuffer& buf, const UString& margin, DID did, TID tid, PDS pds)
{
