...
#define MY_EDID     ts::EDID::Regular(ts::DID_MPEG_IBP, ts::Standards::MPEG)
...
void ts::IBPDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
