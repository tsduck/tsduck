...
#define MY_EDID     ts::EDID::Regular(ts::DID_MPEG_NPT_ENDPOINT, ts::Standards::MPEG)
...
void ts::NPTEndpointDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
