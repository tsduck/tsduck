...
#define MY_EDID     ts::EDID::Regular(ts::DID_MPEG_DEFERRED_ASSOC_TAGS, ts::Standards::MPEG)
...
void ts::DeferredAssociationTagsDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
    buf.pushReadSizeFromLength(8); // association_tags_loop_length
