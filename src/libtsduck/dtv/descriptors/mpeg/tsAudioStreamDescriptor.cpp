...
#define MY_EDID     ts::EDID::Regular(ts::DID_MPEG_AUDIO, ts::Standards::MPEG)
...
void ts::AudioStreamDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
