...
ts::AbstractDeliverySystemDescriptor::AbstractDeliverySystemDescriptor(DID tag, DeliverySystem sys, const UChar* xml_name, Standards standards) :
    AbstractDescriptor(tag, xml_name, standards, 0),
    _system(sys)
{
}
