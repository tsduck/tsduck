...
#define MY_EDID     ts::EDID::Regular(ts::DID_DVB_PDC, ts::Standards::DVB)
...
void ts::PDCDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
