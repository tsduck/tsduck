...
#define MY_EDID     ts::EDID::Regular(ts::DID_DVB_TELEPHONE, ts::Standards::DVB)
...
void ts::TelephoneDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
