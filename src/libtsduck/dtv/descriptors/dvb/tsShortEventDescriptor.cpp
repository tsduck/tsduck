...
#define MY_EDID     ts::EDID::Regular(ts::DID_DVB_SHORT_EVENT, ts::Standards::DVB)
...
void ts::ShortEventDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
