...
#define MY_EDID     ts::EDID::Regular(ts::DID_DVB_SERVICE_AVAIL, ts::Standards::DVB)
...
void ts::ServiceAvailabilityDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
