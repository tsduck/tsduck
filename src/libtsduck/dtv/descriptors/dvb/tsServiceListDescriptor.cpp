...
#define MY_EDID     ts::EDID::Regular(ts::DID_DVB_SERVICE_LIST, ts::Standards::DVB)
...
void ts::ServiceListDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
