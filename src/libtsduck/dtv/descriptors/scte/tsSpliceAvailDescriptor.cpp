...
#define MY_EDID     ts::EDID::TableSpecific(ts::DID_SPLICE_AVAIL, ts::Standards::SCTE, ts::TID_SCTE35_SIT)
...
void ts::SpliceAvailDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
