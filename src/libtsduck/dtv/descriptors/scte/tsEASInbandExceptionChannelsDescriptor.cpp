...
#define MY_EDID     ts::EDID::TableSpecific(ts::DID_EAS_INBAND_EXCEPTS, ts::Standards::SCTE, ts::TID_SCTE18_EAS)
...
void ts::EASInbandExceptionChannelsDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
