...
#define MY_DID ts::DID_ISDB_PART_TS_TIME
...
void ts::PartialTSTimeDescriptor::DisplayDescriptor(TablesDisplay& disp, PSIBuffer& buf, const UString& margin, DID did, TID tid, PDS pds)
{
