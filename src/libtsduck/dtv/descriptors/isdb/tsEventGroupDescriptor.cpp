...
#define MY_EDID     ts::EDID::Regular(ts::DID_ISDB_EVENT_GROUP, ts::Standards::ISDB)
...
void ts::EventGroupDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
