...
#define MY_EDID     ts::EDID::Regular(ts::DID_ISDB_STC_REF, ts::Standards::ISDB)
...
void ts::STCReferenceDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
