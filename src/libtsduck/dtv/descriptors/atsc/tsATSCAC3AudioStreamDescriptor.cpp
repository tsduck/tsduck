...
#define MY_EDID    ts::EDID::Regular(ts::DID_ATSC_AC3, ts::Standards::ATSC)
...
void ts::ATSCAC3AudioStreamDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
