...
#define MY_EDID     ts::EDID::Regular(ts::DID_ATSC_SERVICE_LOC, ts::Standards::ATSC)
...
void ts::ServiceLocationDescriptor::DisplayDescriptor(TablesDisplay& disp, const ts::Descriptor& desc, PSIBuffer& buf, const UString& margin, const ts::DescriptorContext& context)
{
