...
ts::TSAnalyzerArgs::TSAnalyzerArgs(Report* report) :
    json(report)
{
}

ts::TSAnalyzerArgs::~TSAnalyzerArgs()
{
}
...
void ts::TSAnalyzerArgs::defineArgs(Args& args)
{
    ...
    json.defineArgs(args, false, u"Complete report about the transport stream, the services and the PID's in JSON format.");
