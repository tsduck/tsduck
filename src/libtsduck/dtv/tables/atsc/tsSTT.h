...
namespace ts {
    ...
    public:
        ...
        cn::seconds    system_time {};        //!< Number of GPS seconds since 00:00:00 UTC, January 6th, 1980.
        cn::seconds    GPS_UTC_offset {};     //!< Current offset in seconds between GPS and UTC (UTC = GPS - GPS_UTC_offset)
