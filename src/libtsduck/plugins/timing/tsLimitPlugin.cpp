    ...
    ProcessorPlugin(tsp_, u"Limit the global bitrate by dropping packets", u"[options]")
{
    ...
    help(u"threshold1",
         ...
         u"The default is " + UString::Decimal(DEFAULT_THRESHOLD1, 0, true, UString()) + u" packets.");

    option(u"threshold2", '2', UINT32);
    help(u"threshold2",
         u"Specify the second threshold for the number of packets in excess. "
         u"The default is " + UString::Decimal(DEFAULT_THRESHOLD2, 0, true, UString()) + u" packets.");

    option(u"threshold3", '3', UINT32);
    help(u"threshold3",
         u"Specify the third threshold for the number of packets in excess. "
         u"The default is " + UString::Decimal(DEFAULT_THRESHOLD3, 0, true, UString()) + u" packets.");

    option(u"threshold4", '4', UINT32);
    help(u"threshold4",
         u"Specify the fourth threshold for the number of packets in excess. "
         u"The default is " + UString::Decimal(DEFAULT_THRESHOLD4, 0, true, UString()) + u" packets.");
