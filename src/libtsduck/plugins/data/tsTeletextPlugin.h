...
//!
//!  @file
//!  Plugin to extract Teletext subtitles.
//!
//----------------------------------------------------------------------------
...
namespace ts {
    ...
    private:
        ...
        int              _max_frames = 0;               // Max number of Teletext frames to generate.
        UString          _language {};                  // Language to select.
        fs::path         _out_file {};                  // Output file name.
        ...
        SubRipGenerator  _srt_output {};                // Generate SRT output file.
