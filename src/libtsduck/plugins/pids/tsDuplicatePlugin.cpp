...
bool ts::DuplicatePlugin::getOptions()
{
    ...
    _silent_drop = present(u"drop-overflow");
    getIntValue(_max_buffered, u"max-buffered-packets", DEF_MAX_BUFFERED);
