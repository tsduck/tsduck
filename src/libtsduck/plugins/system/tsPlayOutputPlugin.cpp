...
#include "tsPlayOutputPlugin.h"
#include "tsPluginRepository.h"
#include "tsFileUtils.h"
#include "tsRegistry.h"

TS_REGISTER_OUTPUT_PLUGIN(u"play", ts::PlayOutputPlugin);
...
ts::PlayOutputPlugin::PlayOutputPlugin(TSP* tsp_) :
...
bool ts::PlayOutputPlugin::send(const TSPacket* buffer, const TSPacketMetadata* pkt_data, size_t packet_count)
{
...
bool ts::PlayOutputPlugin::searchInPath(UString& result, const UStringVector& path, const UString& name)
{
...
bool ts::PlayOutputPlugin::start()
{
    // Get option values
#if !defined(TS_WINDOWS)
