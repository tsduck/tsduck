...
__ts_cmds=(tsanalyze tsbitrate tscharset tscmp tscrc32 tsdate tsdebug tsdektec tsdump tsecmg tseit tsemmg tsfclean tsfixcc tsflute tsftrunc tsfuzz tsgenecm tshides tslatencymonitor tslsdvb tsnip tsp tspacketize tspcap tspcontrol tspsi tsresync tsscan tssmartcard tsstuff tsswitch tstabcomp tstabdump tstables tsterinfo tstestecmg tsvatek tsversion tsxml)
