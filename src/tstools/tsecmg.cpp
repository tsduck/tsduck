...
namespace {
    ...
    public:
        ...
        std::chrono::milliseconds  ecmCompTime {};          // ECM computation time.
    ...
    ts::Args(u"Minimal generic DVB SimulCrypt-compliant ECMG", u"[options]")
{
    ...
    option<std::chrono::milliseconds>(u"comp-time");
    help(u"comp-time",
    ...
    getIntValue(channelStatus.max_comp_time, u"max-comp-time", uint16_t(std::chrono::milliseconds(ecmCompTime).count() + 100));
